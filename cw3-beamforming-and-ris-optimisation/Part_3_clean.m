...
Max = 10;                            % The number fo channel realisation
...
%%
% % optimal
Avg_p_SOCP_optimal = mean(10*log10(power_SOCP)+30,1);
Avg_p_SDP_optimal = mean(10*log10(power_SDP)+30,1);
Avg_p_KKT_optimal = mean(10*log10(power_KKT)+30,1);

Avg_p_SOCP_random = mean(10*log10(power_SOCP_random)+30,1);
Avg_p_SDP_random = mean(10*log10(power_SDP_random)+30,1);
Avg_p_KKT_random = mean(10*log10(power_KKT_random)+30,1);

% MU MISO case without the RIS (checked correct)
Avg_p_SOCP_MU_MISO = mean(10*log10(SOCP_MU_MISO)+30,1);
Avg_p_SDP_MU_MISO = mean(10*log10(SDP_MU_MISO)+30,1);
Avg_p_KKT_MU_MISO = mean(10*log10(KKT_MU_MISO)+30,1);
...
hold on;
plot(SINR_dB,Avg_p_SDP_MU_MISO,"-.O",'LineWidth',1.5,'MarkerSize',8)
hold on;
plot(SINR_dB,Avg_p_KKT_MU_MISO,"-.x",'LineWidth',1.5,'MarkerSize',8)
grid on;xlabel("SINR Requirment [dB]");ylabel("Transmit Power [dBm]");
